...
import com.thinuka.todos.service.AdminService;
...
@Tag(name = "Admin REST API Endpoints", description = "Operation relatedd to a admin")
@RestController
...
public class AdminController {
    ...
    @Operation(summary = "Get all users", description = "Retrieve a list of all usrs in the system")
    ...
    public UserResponse promoteToAdmin(@PathVariable @Min(1) long userId){
        return adminService.prompteToAdmin(userId);
    }
